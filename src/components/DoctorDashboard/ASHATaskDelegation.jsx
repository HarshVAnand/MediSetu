      ...
      <div className="med-card" style={{ padding: '1.75rem' }}>
        <div style={{ marginBottom: '1.25rem', paddingBottom: '0.85rem', borderBottom: '1px solid var(--border-light)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.2rem' }}>
            <span className="badge badge-teal">Home Care Connection</span>
            <span style={{ fontSize: '0.75rem', color: 'var(--text-subtle)' }}>Doorstep Village Follow-up</span>
          </div>
          <h3 style={{ fontSize: '1.25rem', color: 'var(--primary-navy-dark)', margin: 0, display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
            <HeartHandshake size={20} color="var(--medical-teal)" />
            <span>Assign Home Checkup to Village Health Worker — {patient?.name}</span>
          </h3>
        </div>
